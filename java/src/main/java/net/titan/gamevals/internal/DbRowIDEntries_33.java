...
final class DbRowIDEntries_33 {
    ...
    static GamevalEntry[] entries() {
        return new GamevalEntry[] {
            ...
            new GamevalEntry(16898, "GOTR_SHOP_DATA_WATER_TALISMAN", "gotr_shop_data_water_talisman", "rowtypes"),
            ...
            new GamevalEntry(16940, "GOTR_SHOP_DATA_AIR_TALISMAN", "gotr_shop_data_air_talisman", "rowtypes"),
            new GamevalEntry(16941, "GOTR_SHOP_DATA_ABYSSAL_NEEDLE", "gotr_shop_data_abyssal_needle", "rowtypes"),
            new GamevalEntry(16942, "GOTR_SHOP_DATA_GUARDIANS_EYE", "gotr_shop_data_guardians_eye", "rowtypes"),
            new GamevalEntry(16943, "GOTR_SHOP_DATA_RING_OF_ELEMENTS", "gotr_shop_data_ring_of_elements", "rowtypes"),
            new GamevalEntry(16944, "GOTR_SHOP_DATA_HAT_OF_THE_EYE", "gotr_shop_data_hat_of_the_eye", "rowtypes"),
            new GamevalEntry(16945, "GOTR_SHOP_DATA_ROBE_TOP_OF_THE_EYE", "gotr_shop_data_robe_top_of_the_eye", "rowtypes"),
            new GamevalEntry(16946, "GOTR_SHOP_DATA_ROBE_BOTTOM_OF_THE_EYE", "gotr_shop_data_robe_bottom_of_the_eye", "rowtypes"),
            new GamevalEntry(16947, "GOTR_SHOP_DATA_BOOTS_OF_THE_EYE", "gotr_shop_data_boots_of_the_eye", "rowtypes"),
            new GamevalEntry(16948, "GOTR_SHOP_DATA_ABYSSAL_LANTERN", "gotr_shop_data_abyssal_lantern", "rowtypes"),
            new GamevalEntry(16949, "OMNISHOP_CURRENCY_ABYSSAL_PEARL", "omnishop_currency_abyssal_pearl", "rowtypes"),
            new GamevalEntry(16950, "SKILL_FEATURE_CONSTRUCTION_COS_ROOM_TREASURE_CHEST_MAHOGANY", "skill_feature_construction_cos_room_treasure_chest_mahogany", "rowtypes"),
            new GamevalEntry(16951, "TEMPOROSS_SHOP_DATA", "tempoross_shop_data", "rowtypes"),
